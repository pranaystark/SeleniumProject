...
caldate =int(input("Starting date (add dd) :"))
calmon = int(input("Starting date (add mm ) :"))
...
date = driverxpath('//*[@id="lite_mode_189"]').send_keys(f'{caldate}052021')
date = driverxpath('//*[@id="lite_mode_141"]').send_keys(f'{caldate-6}052021')
...
# date = driverxpath('//td[@class="lite_mode_141"]').send_keys(f'{caldate-6}052021')
...
reset=driverxpath('//*[@id="input_2"]').click()
